...
<body>
    ...
    <nav>
        <ul>
            <li class="logo">Introduzione</li>
            <li class="logo">Norme sulla privacy</li>
            <li class="logo">Termini e servizio</li>
            <li class="logo">Tecnologie</li>
            <li class="logo">Domande frequenti</li>
        </ul>
    </nav>
